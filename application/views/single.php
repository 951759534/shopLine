...
<head>
    ...
    <link href="assets/css/single.css" rel="stylesheet" type="text/css" media="all" />
...
<div class="header2 text-center">
    <div class="container">
        <div class="main-header">
            ...
            <div class="box_1">
                <a href="cart.html"><h3>Cart: <span class="simpleCart_total"></span> (<span id="simpleCart_quantity" class="simpleCart_quantity"></span> items)<img src="assets/images/products/cart.png" alt=""/></h3></a>
                        ...
                        <ul id="etalage">
                            <li>
                                <a href="optionallink.html">
                                    <img class="etalage_thumb_image" src="assets/images/products/s1.jpg" />
                                    <img class="etalage_source_image" src="assets/images/products/s1.jpg" />
                                </a>
                            </li>
                            <li>
                                <img class="etalage_thumb_image" src="assets/images/products/s2.jpg" />
                                <img class="etalage_source_image" src="assets/images/products/s2.jpg"/>
                            </li>
                            <li>
                                <img class="etalage_thumb_image" src="assets/images/products/s3.jpg" />
                                <img class="etalage_source_image" src="assets/images/products/s3.jpg" />
                            </li>
                            <li>
                                <img class="etalage_thumb_image" src="assets/images/products/s4.jpg" />
                                <img class="etalage_source_image" src="assets/images/products/s4.jpg" />
                            </li>
                            <div class="clearfix"></div>
                        </ul>
                    </div>
        ...
        <div class="single-bottom2">
            ...
            <div class="rltd-posts">
                <div class="col-md-3 pst1">
                    <img src="assets/images/products/ab3.jpg" alt=""/>
                ...
                <div class="col-md-3 pst1">
                    <img src="assets/images/products/ab4.jpg" alt=""/>
